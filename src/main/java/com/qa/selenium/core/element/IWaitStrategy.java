...
public class IWaitStrategy extends Baseclass {
	...
	public static void waitForVisiblityDynamic(ExtentTest test, WebDriver driver, String Xpath, int time) {
		WebDriverWait wait1 = new WebDriverWait(driver, time);
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(Xpath)));
	}

	public static void waitForInvisiblity(ExtentTest test, WebDriver driver, String Xpath, int duration) {
		// Wait for the progress bar to complete (adjust timeout as needed)
	...
	public static void waitForElementPresence(ExtentTest test, WebDriver driver, String Xpath, int duration) {
	...
	public static void waitForVisiblityAndPresence(ExtentTest test, WebDriver driver, String Xpath) {
		WebDriverWait wait1 = new WebDriverWait(driver, 50);
		wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(Xpath)));
		wait1.until(ExpectedConditions.elementToBeClickable(By.xpath(Xpath)));
	}
	 ...
	 * @since 01.08.2021
	 */
	public static boolean WaitUntilElementClickable(ExtentTest test, WebDriver driver, String el) {
	...
	public static void WaitForPageLoadingToComplete(ExtentTest test, WebDriver driver) {
		...
		PauseTestExecution(2);// Additional Wait - which is found useful
