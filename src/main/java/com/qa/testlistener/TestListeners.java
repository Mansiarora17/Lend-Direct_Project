...
public class TestListeners implements ITestListener {
	...
	public void onTestSkipped(ITestResult result) {
		Baseclass.extenttest = Baseclass.extent.createTest(result.getMethod().getDescription())
				.assignCategory("SkipedTest");
		...
		Baseclass.node.log(Status.INFO,
				"Test with name : " + result.getName() + " is Skipped as its depending test failed");
